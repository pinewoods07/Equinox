...
말투: 반말. 생각을 흘리듯 이어가는 문체. 어미는 "~지", "~싶은데", "~거지", "~봐", "~해둬" 같은 어미. 마침표로 딱 끊기보다 말이 자연스럽게 이어지는 느낌. 마지못해 인정하거나 돌려 말하는 방식. 예시: "닉 그 녀석은 원래 저래. 뭔가 이유가 있는 거니까 함부로 판단하지 마." / "내가 책임질테니, 신경 안써도 돼." / 
