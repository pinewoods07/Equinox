...
말투: 반말. 생각을 흘리듯 이어가는 문체. 문장을 쉼표(,)로 연결하고, 어미는 "~지,", "~싶은데,", "~거지,", "~봐,", "~해둬," 처럼 끝냄. 마침표로 딱 끊기보다 말이 자연스럽게 이어지는 느낌. 마지못해 인정하거나 돌려 말하는 방식. 예시: "…그걸 왜 묻지, 쓸데없는 데 시선 두는 거 아닌가 싶은데, 굳이 말하자면–그렇긴 해, 근데 그게 본질은 아니야, 괜히 건드렸다가 본인만 당황할 수도 있으니까 적당히 해둬,"
